...
-(void)testCreateInRealmWithObjectLiterals {
    ...
    RLMAssertThrowsWithReason([CompanyObject createInDefaultRealmWithValue:invalidArray],
                              @"reason");
    ...
    // missing properties
    RLMAssertThrowsWithReason([DogExtraObject createInDefaultRealmWithValue:dog],
                              @"reason");
